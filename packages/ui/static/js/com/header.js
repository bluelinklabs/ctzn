    ...
    return html`
      <div class="desktop-header hidden lg:block sticky top-0 z-20">
        <div class="desktop-header-inner flex items-center leading-none">
          ...
          <a href="/p/explore" class=${this.getHeaderNavClass('/p/explore')} @click=${this.onClickLink}>
            <span class="fas fa-fw navicon fa-compass"></span>
            Explore
          </a>
          <a href="/p/notifications" class="relative ${this.getHeaderNavClass('/p/notifications')}" @click=${this.onClickLink}>
            ${this.unreadNotificationsCount > 0 ? html`
              <span class="absolute bg-blue-500 font-medium leading-none px-1.5 py-0.5 rounded-2xl text-white text-xs" style="top: 10px; left: 20px">${this.unreadNotificationsCount}</span>
            ` : ''}
      ...
      <div class="menu ${this.isMenuOpen ? 'open transition-enabled' : 'closed'} flex flex-col leading-none font-medium bg-white">
        ...
        <div class="flex flex-col px-2">
          ...
          <a href="/p/notifications" class="relative ${this.getMenuNavClass('/p/notifications')}" @click=${this.onClickLink}>
            ${this.unreadNotificationsCount > 0 ? html`
