...
test('basic CRUD', async t => {
  ...
  let comment1 = await api.comments.get('bobo', comments[0].key)
  ...
  let comment2 = await api.comments.get('bobo', comments[1].key)
  ...
  let comment1Edited = await api.comments.get('bobo', comments[0].key)
  ...
  let comment1Edited2 = await api.comments.get('bobo', comments[0].key)
  ...
  await t.throwsAsync(() => api.comments.get('bobo', comments[0].key))
