...
test('self indexes', async t => {
  ...
  await bob.login()
  let res = await api.reactions.getReactionsForSubject(bob.posts[0].url)
  ...
  // see all reactions by users followed by authed
  await bob.login()
  res = await api.reactions.getReactionsForSubject(bob.posts[1].url)
  ...
  await carla.login()
  res = await api.reactions.getReactionsForSubject(bob.posts[0].url)
  t.is(res.subject.dbUrl, bob.posts[0].url)
  t.is(res.reactions.like.length, 2)
  t.is(res.reactions.woah.length, 1)
  ...
  await carla.login()
  res = await api.reactions.getReactionsForSubject(alice.posts[0].url)
...
test('community indexes', async t => {
  ...
  await bob.login()
  let res = await api.reactions.getReactionsForSubject(bob.posts[2].url)
  ...
  await carla.login()
  res = await api.reactions.getReactionsForSubject(bob.posts[2].url)
  t.is(res.subject.dbUrl, bob.posts[2].url)
  t.is(res.reactions.like.length, 2)
  t.is(res.reactions.woah.length, 1)
