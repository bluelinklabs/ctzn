...
.image-loading {
  width: 14px;
  height: 14px;
  background: url(${unsafeCSS((new URL('../../img/spinner.gif', (document.currentScript && document.currentScript.src || new URL('user.build.js', document.baseURI).href))).toString())});
  background-size: 100%;
}
...
`;
    ...
    class Composer extends LitElement {
      ...
      render () {
        return html`
      <link rel="stylesheet" href=${(new URL('../../css/fontawesome.css', (document.currentScript && document.currentScript.src || new URL('user.build.js', document.baseURI).href))).toString()}>
      <link rel="stylesheet" href=${(new URL('../vs/editor/editor.main.css', (document.currentScript && document.currentScript.src || new URL('user.build.js', document.baseURI).href))).toString()}>
    ...
    EditProfilePopup.styles = [cssStr$2, css`
input,
textarea {
  font-size: 17px;
}
    ...
    `
      ...
      async onClickEditProfile (e) {
        ...
        try {
          ...
          create('Profile updated', 'success');
          this.requestUpdate();
        } catch (e) {
          create(e.message, 'error');
          console.error(e);
